    ...
    <div className="min-h-screen mini-page">
      ...
      <div className="relative overflow-hidden rounded-b-[32px] bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-700 px-5 pt-16 pb-12">
        ...
        <div className="relative z-10 text-center">
          <div className="w-20 h-20 rounded-lg bg-white/20 backdrop-blur-md flex items-center justify-center text-3xl font-bold text-white shadow-lg mx-auto mb-4">
            {station.name[0]}
          </div>
      ...
      <div className="px-4 -mt-6 relative z-10">
        <div className="mini-card p-5 ">
          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="flex items-start gap-3 bg-orange-50/50 rounded-lg p-3">
          ...
          <div className="bg-gray-50 rounded-lg p-3 mb-5">
            ...
            <div className="flex items-center justify-between text-sm mt-2">
              ...
              <span className="text-gray-500">站内消息通知</span>
            </div>
          </div>
          ...
          <Link
            href="/home"
            className="w-full py-3.5 rounded-lg mini-primary text-white font-semibold text-base shadow-lg shadow-blue-500/25 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
          >
            授权手机号并绑定
            <ArrowRight size={18} />
          </Link>
